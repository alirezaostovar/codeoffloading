...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String IDEA_EncDecintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(IDEA_EncDecintent);
    }
    ...
    private void changelabellocal(String IDEA_EncDecintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String IDEA_EncDecintent = intent.getStringExtra("IDEA_EncDecintent");
                
                changelabelcloud(IDEA_EncDecintent);
        	}else{
        		String IDEA_EncDecLocalintent = intent.getStringExtra("IDEA_EncDecintent");
                
                changelabellocal(IDEA_EncDecLocalintent);
        	}
        	try {
