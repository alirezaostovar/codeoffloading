...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String PrimeFactorsintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.PrimeFactors);
    	tv1.setText(PrimeFactorsintent);
    }
    ...
    private void changelabellocal(String PrimeFactorsintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.PrimeFactorsLocal);
    	tv1.setText(PrimeFactorsintent);
    }
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String PrimeFactorsintent = intent.getStringExtra("PrimeFactorsintent");
                
                changelabelcloud(PrimeFactorsintent);
        	}else{
        		String PrimeFactorsLocalintent = intent.getStringExtra("PrimeFactorsintent");
                
                changelabellocal(PrimeFactorsLocalintent);
        	}
        	try {
