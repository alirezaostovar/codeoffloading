...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String MergeSortintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(MergeSortintent);
    }
    ...
    private void changelabellocal(String MergeSortintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String MergeSortintent = intent.getStringExtra("MergeSortintent");
                
                changelabelcloud(MergeSortintent);
        	}else{
        		String MergeSortLocalintent = intent.getStringExtra("MergeSortintent");
                
                changelabellocal(MergeSortLocalintent);
        	}
        	try {
