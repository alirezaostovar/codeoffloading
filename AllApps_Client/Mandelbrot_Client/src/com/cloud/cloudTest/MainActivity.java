...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String Mandelbrotintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(Mandelbrotintent);
    }
    ...
    private void changelabellocal(String Mandelbrotintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String Mandelbrotintent = intent.getStringExtra("Mandelbrotintent");
                
                changelabelcloud(Mandelbrotintent);
        	}else{
        		String MandelbrotLocalintent = intent.getStringExtra("Mandelbrotintent");
                
                changelabellocal(MandelbrotLocalintent);
        	}
        	try {
