...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String NeuralNetintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(NeuralNetintent);
    }
    ...
    private void changelabellocal(String NeuralNetintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String NeuralNetintent = intent.getStringExtra("NeuralNetintent");
                
                changelabelcloud(NeuralNetintent);
        	}else{
        		String NeuralNetLocalintent = intent.getStringExtra("NeuralNetintent");
                
                changelabellocal(NeuralNetLocalintent);
        	}
        	try {
