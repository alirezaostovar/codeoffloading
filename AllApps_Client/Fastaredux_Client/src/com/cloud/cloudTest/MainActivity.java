...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String Fastareduxintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(Fastareduxintent);
    }
    ...
    private void changelabellocal(String Fastareduxintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String Fastareduxintent = intent.getStringExtra("Fastareduxintent");
                
                changelabelcloud(Fastareduxintent);
        	}else{
        		String FastareduxLocalintent = intent.getStringExtra("Fastareduxintent");
                
                changelabellocal(FastareduxLocalintent);
        	}
        	try {
