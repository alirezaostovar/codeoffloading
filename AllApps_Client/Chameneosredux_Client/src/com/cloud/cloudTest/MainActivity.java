...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String Chameneosreduxintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(Chameneosreduxintent);
    }
    ...
    private void changelabellocal(String Chameneosreduxintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String Chameneosreduxintent = intent.getStringExtra("Chameneosreduxintent");
                
                changelabelcloud(Chameneosreduxintent);
        	}else{
        		String ChameneosreduxLocalintent = intent.getStringExtra("Chameneosreduxintent");
                
                changelabellocal(ChameneosreduxLocalintent);
        	}
