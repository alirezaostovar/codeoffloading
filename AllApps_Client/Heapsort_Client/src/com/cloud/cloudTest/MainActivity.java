...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String Heapsortintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(Heapsortintent);
    }
    ...
    private void changelabellocal(String Heapsortintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String Heapsortintent = intent.getStringExtra("Heapsortintent");
                
                changelabelcloud(Heapsortintent);
        	}else{
        		String HeapsortLocalintent = intent.getStringExtra("Heapsortintent");
                
                changelabellocal(HeapsortLocalintent);
        	}
        	try {
