...
//MeteorContest with N = 2098

public class MeteorContest
 extends CloudRemotable   { // CONSTANTS
    ...
    @Cloud
    public void localRunMeteorContest()
       {
        int N = 2098;
         ...
         MeteorContest        puzzle = new MeteorContest ();
         Date      start;
         Date      end;
         long      time;
...
//          System.out.print("\n");
    ...
    private static class Piece implements Serializable
...
void copyState(Object state){
	MeteorContest
 localstate = (MeteorContest
) state;
	this.solutions = localstate.solutions;
	this.solution = localstate.solution;
	this.depth = localstate.depth;
	this.pieces = localstate.pieces;
} }
