...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String Ackermannintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(Ackermannintent);
    }
    ...
    private void changelabellocal(String Ackermannintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String Ackermannintent = intent.getStringExtra("Ackermannintent");
                
                changelabelcloud(Ackermannintent);
        	}else{
        		String AckermannLocalintent = intent.getStringExtra("Ackermannintent");
                
                changelabellocal(AckermannLocalintent);
        	}
