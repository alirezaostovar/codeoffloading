...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String ShellSortintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(ShellSortintent);
    }
    ...
    private void changelabellocal(String ShellSortintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String ShellSortintent = intent.getStringExtra("ShellSortintent");
                
                changelabelcloud(ShellSortintent);
        	}else{
        		String ShellSortLocalintent = intent.getStringExtra("ShellSortintent");
                
                changelabellocal(ShellSortLocalintent);
        	}
        	try {
