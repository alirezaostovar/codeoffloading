...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String InsertionSortintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(InsertionSortintent);
    }
    ...
    private void changelabellocal(String InsertionSortintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String InsertionSortintent = intent.getStringExtra("InsertionSortintent");
                
                changelabelcloud(InsertionSortintent);
        	}else{
        		String InsertionSortLocalintent = intent.getStringExtra("InsertionSortintent");
                
                changelabellocal(InsertionSortLocalintent);
        	}
        	try {
