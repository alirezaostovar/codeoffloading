...
//Multithread Fannkuch redux with n = 11

public final class Fannkuchredux extends CloudRemotable  implements Runnable
{
   ...
   @Cloud
   public void localRunFannkuchredux()
   {
...
void copyState(Object state){
	Fannkuchredux localstate = (Fannkuchredux) state;
	this.CHUNKSZ = localstate.CHUNKSZ;
	this.NTASKS = localstate.NTASKS;
	this.n = localstate.n;
	this.Fact = localstate.Fact;
	this.maxFlips = localstate.maxFlips;
	this.chkSums = localstate.chkSums;
	this.taskId = localstate.taskId;
	this.p = localstate.p;
	this.pp = localstate.pp;
