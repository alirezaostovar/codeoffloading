...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String Fannkuchreduxintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(Fannkuchreduxintent);
    }
    ...
    private void changelabellocal(String Fannkuchreduxintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String Fannkuchreduxintent = intent.getStringExtra("Fannkuchreduxintent");
                
                changelabelcloud(Fannkuchreduxintent);
        	}else{
        		String FannkuchreduxLocalintent = intent.getStringExtra("Fannkuchreduxintent");
                
                changelabellocal(FannkuchreduxLocalintent);
        	}
        	try {
