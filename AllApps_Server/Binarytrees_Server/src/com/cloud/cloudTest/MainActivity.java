...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String Binarytreesintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(Binarytreesintent);
    }
    ...
    private void changelabellocal(String Binarytreesintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String Binarytreesintent = intent.getStringExtra("Binarytreesintent");
                
                changelabelcloud(Binarytreesintent);
        	}else{
        		String BinarytreesLocalintent = intent.getStringExtra("Binarytreesintent");
                
                changelabellocal(BinarytreesLocalintent);
        	}
