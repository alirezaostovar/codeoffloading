...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String Assignmentintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(Assignmentintent);
    }
    ...
    private void changelabellocal(String Assignmentintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String Assignmentintent = intent.getStringExtra("Assignmentintent");
                
                changelabelcloud(Assignmentintent);
        	}else{
        		String AssignmentLocalintent = intent.getStringExtra("Assignmentintent");
                
                changelabellocal(AssignmentLocalintent);
        	}
        	try {
