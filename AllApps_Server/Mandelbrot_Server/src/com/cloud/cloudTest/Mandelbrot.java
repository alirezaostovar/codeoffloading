...
//Mandelbrot set with N=6000

public final class Mandelbrot extends CloudRemotable  {
  static byte[][] out;
  ...
  @Cloud
  public void localRunMandelbrot() throws Exception {
...
//     stream.close();
  ...
  public void RunMandelbrot() throws Exception {
	Method toExecute; 
	Class<?>[] paramTypes = null; 
	Object[] paramValues = null; 
	
	try{
		toExecute = this.getClass().getDeclaredMethod("localRunMandelbrot", paramTypes);
...
void copyState(Object state){
	Mandelbrot localstate = (Mandelbrot) state;
	this.out = localstate.out;
	this.yCt = localstate.yCt;
	this.Crb = localstate.Crb;
	this.Cib = localstate.Cib;
}
}
