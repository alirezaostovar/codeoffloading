...
import com.cloud.cloudTest.Nbody.Nbody;
...
//    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
  ...
  private void RunFuncs() {
      ...
      avgNbodyTime = avg(execTimes);



      notifytochangelable("Average Nbody Time: " + avgNbodyTime);
  }
  ...
  public void notifytochangelable(String NbodyTime){
		Intent intent = new Intent(MainActivity.changelabel);
	    intent.putExtra("iscloud", false);
	    intent.putExtra("Nbodyintent", NbodyTime);
