...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String Nbodyintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(Nbodyintent);
    }
    ...
    private void changelabellocal(String Nbodyintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String Nbodyintent = intent.getStringExtra("Nbodyintent");
                
                changelabelcloud(Nbodyintent);
        	}else{
        		String NbodyLocalintent = intent.getStringExtra("Nbodyintent");
                
                changelabellocal(NbodyLocalintent);
        	}
        	try {
