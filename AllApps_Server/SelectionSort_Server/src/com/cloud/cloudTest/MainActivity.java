...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String SelectionSortintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(SelectionSortintent);
    }
    ...
    private void changelabellocal(String SelectionSortintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String SelectionSortintent = intent.getStringExtra("SelectionSortintent");
                
                changelabelcloud(SelectionSortintent);
        	}else{
        		String SelectionSortLocalintent = intent.getStringExtra("SelectionSortintent");
                
                changelabellocal(SelectionSortLocalintent);
        	}
        	try {
