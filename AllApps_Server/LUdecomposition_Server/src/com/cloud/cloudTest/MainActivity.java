...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String LUdecompositionintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(LUdecompositionintent);
    }
    ...
    private void changelabellocal(String LUdecompositionintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String LUdecompositionintent = intent.getStringExtra("LUdecompositionintent");
                
                changelabelcloud(LUdecompositionintent);
        	}else{
        		String LUdecompositionLocalintent = intent.getStringExtra("LUdecompositionintent");
                
                changelabellocal(LUdecompositionLocalintent);
        	}
        	try {
