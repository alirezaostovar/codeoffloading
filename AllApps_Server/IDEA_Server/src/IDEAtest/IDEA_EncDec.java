...
//
//    System.out.println("\nAverage IDEA_EncDec Time: " + new IDEA_EncDec().dotest());
//}
...
void copyState(Object state){
	IDEA_EncDec
 localstate = (IDEA_EncDec
) state;
	this.plain1 = localstate.plain1;
	this.crypt1 = localstate.crypt1;
	this.plain2 = localstate.plain2;
	this.userkey = localstate.userkey;
	this.Z = localstate.Z;
	this.DK = localstate.DK;
