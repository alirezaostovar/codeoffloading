...
public class MainActivity extends Activity {
    ...
    private void changelabelcloud(String MeteorContestintent){
    	TextView tv1 = (TextView)this.findViewById(R.id.label);
    	tv1.setText(MeteorContestintent);
    }
    ...
    private void changelabellocal(String MeteorContestintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
        	...
        	if(iscloud){
        		String MeteorContestintent = intent.getStringExtra("MeteorContestintent");
                
                changelabelcloud(MeteorContestintent);
        	}else{
        		String MeteorContestLocalintent = intent.getStringExtra("MeteorContestintent");
                
                changelabellocal(MeteorContestLocalintent);
        	}
        	try {
